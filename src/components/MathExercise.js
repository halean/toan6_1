...
function ExpandableDiv({content}) {
  ...
  return (
    <div className="border p-3 rounded">
      ...
      >
        <h2 className="text-lg">Nhấn vào để {expanded ? 'đóng' : 'xem'} giải thích đoạn mã</h2>
...
function MathExercise({exercise}) {
  ...
  return (
    ...
    <ExpandableDiv content={parse(exercise.code_explain)} />
